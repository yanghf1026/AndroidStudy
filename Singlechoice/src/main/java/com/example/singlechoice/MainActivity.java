...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt = findViewById(R.id.bt); //通过ID获取布局提交按钮
        rg = findViewById(R.id.rg);//通过ID获取布局单选按钮
                ...
                for(int i = 0;i < rg.getChildCount();i++){
                    ...
                    if(radioButton.isChecked()){ //判断单选按钮是否被选中
                        if(radioButton.getText().equals("B:100")){//判断答案是否正确
                            ...
                            builder.setMessage("回答错误，下面请看解析：当张山换完零钱之后， 给了顾客75还有价值25元的商品，自己还剩下了25元。这时， 李石来找张山要钱，张山把自己剩下的相当于是李石的25元给了李石， 另外自己掏了75元。这样张山赔了一个25元的商品和75元的人民币， 总共价值100元。");
